<x-app-layout>
    ...
    <div class="w-4/5 grid xl:grid-cols-4 sm:grid-cols-2 gap-4 m-auto items-center mx-auto mb-5 ">
        ...
        <div class="m-2 flex justify-evenly items-center p-5 text-center border rounded-lg shadow bg-[#ffffff] border-gray-700 hover:bg-[#b9b9b9]">
            <div class="w-1/6 text-gray-300">
                <svg class="text-[#FF6F3C]" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"
        ...
        <div
            class="m-2 flex justify-evenly items-center p-5 text-center border rounded-lg shadow bg-[#ffffff] border-gray-700 hover:bg-[#b9b9b9]">
            <div class="w-1/6 text-gray-300">
                <svg class="text-[#FF6F3C]" aria-hidden="true" fill="currentColor" viewBox="0 0 512 512"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    <div class="w-4/5 flex justify-center items-center flex-wrap m-auto">
        @if ($ultimaRec)
            <div
                ...
                <h5 class="mb-2 text-xl font-bold tracking-tight text-[#ffffff] dark:text-gray-300">Reclamação
                    mais
                    recente:
                </h5>
                <p class="mb-2 text-xl font- tracking-tight text-[#ffffff] dark:text-gray-300">Laboratório:
                    {{ $ultimaRec->laboratorio->laboratorio }}</p>
                <p class="mb-2 text-xl font- tracking-tight text-[#ffffff] dark:text-gray-300">N° do Computador:
                    {{ $ultimaRec->pc }}
                </p>
                <p class="mb-2 text-xl font- tracking-tight text-[#ffffff] dark:text-gray-300">Feita em:
                ...
                scales: {
                    y: {
                        ticks: {
                            ...
                            precision: 0,
                            stepSize: 1,
                            color: '#ffffff' // Change the font color of y-axis labels here
                        }
                    },
                    x: {
                        ticks: {
                            color: '#fff' // Change the font color of x-axis labels here
                        }
                    }
                },
            }
